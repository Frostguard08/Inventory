    ...
    <div class="admin-contents">
      ...
      <div class="filter">
        ...
        <tr>
			...
			<td style="padding:1rem;"><a  onclick="window.open(this.href); return false" class="btn" style="padding:0.8rem;" href="../order/printReceipt.php?id=<?php echo $item['serial_number']; ?>">Print</a></td>
        </tr>
        <?php endforeach;?>	
        </table>
      </div>
